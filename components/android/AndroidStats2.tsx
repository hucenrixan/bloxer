const bars = [
  { label: "Performance", value: 97, color: "bg-purple-500" },
  { label: "Reliability", value: 99, color: "bg-green-500" },
  { label: "User Satisfaction", value: 96, color: "bg-indigo-500" },
  { label: "Play Store Rating", value: 96, color: "bg-yellow-400" },
];

export default function AndroidStats2() {
  return (
    <section className="py-16 px-6 bg-white" style={{ fontFamily: "'Google Sans','Roboto',sans-serif" }}>
      <div className="max-w-sm mx-auto">
        ...
        <div className="mt-8 grid grid-cols-3 gap-3 text-center">
          {[{ v: "30K+", l: "Downloads" }, { v: "4.8★", l: "Rating" }, { v: "#1", l: "Productivity" }].map(s => (
            <div key={s.l} className="bg-gray-50 rounded-3xl p-4 border border-gray-100">
